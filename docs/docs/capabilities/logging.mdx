...
Logging helps operators understand what Lightflare is doing. It records application startup, agent execution, tool activity, scheduling, memory work, and errors.
